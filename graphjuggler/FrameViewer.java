...
public class FrameViewer extends JFrame implements WindowListener, ActionListener{
	...
	JButton buttonNewVertex = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/vertex.png")));
	...
	JButton buttonNewEdge = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/edge.png")));
	...
	JButton buttonSave = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/save.png")));
	...
	JButton buttonZoomOut = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/zoom_out.png")));
	...
	JButton buttonZoomIn = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/zoom_in.png")));
	toolPanel.add(buttonZoomIn);
	buttonZoomIn.addActionListener(new ActionZoomIn(this,vs));
	buttonZoomIn.setToolTipText("zoom in");
	JButton buttonPrint = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/print.png")));
	toolPanel.add(buttonPrint);
	buttonPrint.addActionListener(new ActionPrint(this,vs));
	buttonPrint.setToolTipText("print graph");
	JButton buttonLatex = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/latex.png")));
	...
	JButton buttonEnd = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/noend.png")));
	toolPanel.add(buttonEnd);
	buttonEnd.addActionListener(new ActionEnd(this,vs));
	buttonEnd.setSelectedIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/end.png")));
	buttonEnd.setToolTipText("endomorphisms"); 
	buttonEnd.setSelected(true);
	JButton buttonQuit = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/quit.png")));
	...
	JButton button = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/card.png")));
